...
public class GlobalDataAccess extends BasicJdbcSupport {
    ...
    protected String RECALLS_COLS = "ID,SOURCE_ORGANIZATION,RECALLS_ID,RECALL_NUMBER,RECALL_REASON,RECALL_STATUS,RECALL_DATE,LAST_PUBLISH_DATE,RECALL_DESCRIPTION,RECALL_URL,RECALL_CLASSIFICATION,RECALL_VOLUNTARY_MANDATED,CONSUMER_CONTACT,REPORTED_COMPLAINTS,REMEDIES";
    protected String PRODUCTS_COLS = "RECALLS_ID,UPCS,NAME,DESCRIPTION,MODEL,TYPE,CATEGORY_ID,IMAGES,PRODUCT_QUANTITY";
    protected String MANUFACTURER_COLS = "ID,RECALLS_ID,NAME";
    ...
    protected String INSERT_MANUFACTURER_SQL = String.format("INSERT INTO MANUFACTURER (%s) VALUES (%s)", MANUFACTURER_COLS, GeneralUtils.multiplyStringWithToken("?", ",", MANUFACTURER_COLS.split(",").length));
    protected String INSERT_MANUFACTURER_LOCATIONS_SQL = String.format("INSERT INTO MANUFACTURER (%s) VALUES (%s)", MANUFACTURER_LOCATIONS_COLS, GeneralUtils.multiplyStringWithToken("?", ",", MANUFACTURER_LOCATIONS_COLS.split(",").length));
