...
CREATE TABLE RECALLS (
  ...
  RECALL_REASON VARCHAR(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  RECALL_STATUS VARCHAR(100),
  RECALL_DATE DATETIME, 
  LAST_PUBLISH_DATE DATETIME,
  RECALL_DESCRIPTION TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  RECALL_URL VARCHAR(300),
  RECALL_CLASSIFICATION VARCHAR(50),
  RECALL_VOLUNTARY_MANDATED VARCHAR(50),
  CONSUMER_CONTACT VARCHAR(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  REPORTED_COMPLAINTS TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  REMEDIES TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE PRODUCTS (
    ...
    UPCS VARCHAR(1000),
    NAME VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
    DESCRIPTION VARCHAR(1000),
    MODEL VARCHAR(100),
    TYPE VARCHAR(100),
    CATEGORY_ID VARCHAR(100),
    IMAGES VARCHAR(4000),
     PRODUCT_QUANTITY VARCHAR(600),
  CREATE_DATE DATETIME DEFAULT NOW()
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE MANUFACTURERS_LOCATIONS(
   ID SERIAL PRIMARY KEY,
   MANUFACTURERS_ID VARCHAR(20) REFERENCES MANUFACTURERS(ID),
   COUNTRY VARCHAR(100),
   STATE VARCHAR(100),
   CITY VARCHAR(100),
  CREATE_DATE DATETIME DEFAULT NOW()
...
CREATE TABLE HAZARDS (
   ID SERIAL PRIMARY KEY,
   RECALLS_ID VARCHAR(20) REFERENCES RECALLS(ID),
   HAZARD VARCHAR(1000)CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
